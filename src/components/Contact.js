...
function Contact(props) {
    return (
        <div>
            <div
      className="relative z-10 overflow-hidden bg-emp-dark-orange pt-[120px] pb-[100px] md:pt-[130px] lg:pt-[160px]"
    >
    ...
    <section id="contact" className="ud-contact relative py-20 md:py-[120px]">
      <div
        className="absolute top-0 left-0 z-[-1] h-1/2 w-full bg-emp-light lg:h-[45%] xl:h-1/2"
      ></div>
          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div className="ud-contact-content-wrapper">
              <div className="ud-contact-title mb-12 lg:mb-[150px]">
                <span
                  className="font-headingFont mb-5 text-base font-semibold text-dark"
                >
                  CONTACT US
                </span>
                ...
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="text-base text-body-color">
                      Bole Dildiy, Addis Ababa, Ethiopia
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="text-base text-body-color"><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="f49d9a929bb48d9b8186909b99959d9ada979b99">example@mail.com</a></p>
                    <p className="text-base text-body-color">
                      <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="60030f0e1401031420190f1512040f0d01090e4e030f0d">example@mail.com</a>
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <form>
                ...
                <div className="mb-0">
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center rounded bg-emp-dark-orange py-4 px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-dark"
                  >
                    Send Message
                  </button>
                </div>
